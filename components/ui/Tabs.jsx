...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
    <TabsPrimitive.List
        ref={ref}
        className={cn(
            "inline-flex items-center justify-center lg:bg-white p-1 text-muted-foreground rounded-[30px] dark:md:bg-secondary fixed top-14 top-11 md:sticky md:py-4 md:top-16 md:rounded-none bg-white",
            className
        )}
        {...props} />
))
